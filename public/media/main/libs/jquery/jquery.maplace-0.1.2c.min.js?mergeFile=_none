...
/**
* Edited by Tash Mirza
* Line 27: Added additional statement --> e['html'] += "<a class='data' data-lat='" + e['lat'] + "' data-lon='" + e['lon'] + "'></a>"
* This creates an <a> tag inside the info window after the content with attributes 'data-lon' and 'data-lat' which holds the values of the 
* current markers longitude and latitude respectively. Those values are used to calculate routes.
*/
    ...
    p = function() {
        ...
        c.prototype.create = {marker: function(a) {
                ...
                d.maps.event.addListener(c, "click", function() {
                    ...
                    e['html'] += "<a class='data' data-lat='" + e['lat'] + "' data-lon='" + e['lon'] + "'></a>";
