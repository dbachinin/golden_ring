...
class FotosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create foto" do
    assert_difference('Foto.count') do
      post fotos_url, params: { foto: { description: @foto.description, foto: @foto.foto, item: @foto.item } }
    end
  ...
  test "should update foto" do
    patch foto_url(@foto), params: { foto: { description: @foto.description, foto: @foto.foto, item: @foto.item } }
